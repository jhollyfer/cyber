...
Isso e necessario porque variaveis `VITE_*` sao inlined durante o build. O entrypoint faz find-and-replace nos arquivos compilados para substituir `http://localhost:4000` pela URL real da API conforme o ambiente de deploy.
