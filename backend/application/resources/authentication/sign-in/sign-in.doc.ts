...
export const SignInDocumentationSchema: FastifySchema = {
  tags: ['Authentication'],
  summary: 'User authentication sign in',
  description:
    'Authenticates a user with phone and password, returning JWT tokens as HTTP-only cookies',
  body: {
    type: 'object',
  ...
  response: {
    ...
    400: {
      ...
      properties: {
        ...
        errors: {
          type: 'object',
          properties: {
            phone: { type: 'string', description: 'Phone error message' },
            password: { type: 'string', description: 'Password error message' },
          },
        },
      },
    },
    ...
    500: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['SIGN_IN_ERROR'] },
      },
    },
  },
};
