...
export const SignUpDocumentationSchema: FastifySchema = {
  tags: ['Authentication'],
  ...
  response: {
    201: {
      description:
        'Registration successful - Sets httpOnly cookies for accessToken and refreshToken',
      type: 'object',
      properties: {
    ...
    409: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['USER_ALREADY_EXISTS'] },
      },
    },
    500: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['SIGN_UP_ERROR'] },
      },
    },
  },
};
