...
export const FinishSessionDocumentationSchema: FastifySchema = {
  tags: ['Game'],
  ...
  response: {
    ...
    404: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['SESSION_NOT_FOUND'] },
      },
    },
    400: {
      ...
      type: 'object',
      properties: {
        message: { type: 'string', examples: ['Session is already finished'] },
        code: { type: 'number', examples: [400] },
        cause: { type: 'string', examples: ['SESSION_ALREADY_FINISHED'] },
      },
    },
    403: {
    ...
    500: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['FINISH_SESSION_ERROR'] },
      },
    },
  },
};
