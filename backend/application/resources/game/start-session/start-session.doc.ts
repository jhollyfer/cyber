...
export const StartSessionDocumentationSchema: FastifySchema = {
  tags: ['Game'],
  ...
  response: {
    ...
    400: {
      ...
      type: 'object',
      properties: {
        message: { type: 'string', examples: ['Module is not active'] },
        code: { type: 'number', examples: [400] },
        cause: { type: 'string', examples: ['MODULE_NOT_ACTIVE'] },
      },
    },
    500: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['START_SESSION_ERROR'] },
      },
    },
  },
};
