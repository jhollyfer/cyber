...
export const CreateQuestionDocumentationSchema: FastifySchema = {
  tags: ['Questions'],
  ...
  params: {
    ...
    required: ['moduleId'],
    properties: {
      moduleId: { type: 'string', format: 'uuid', description: 'Module ID' },
    },
  },
  body: {
    type: 'object',
  ...
  response: {
    ...
    500: {
      ...
      properties: {
        ...
        cause: { type: 'string', examples: ['CREATE_QUESTION_ERROR'] },
      },
    },
  },
};
