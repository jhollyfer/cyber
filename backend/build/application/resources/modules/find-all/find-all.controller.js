...
} from "../../../../chunk-PCXCTPMO.js";
import {
  FindAllModulesUseCase
} from "../../../../chunk-JJHMWQ43.js";
import {
...
// application/resources/modules/find-all/find-all.controller.ts
...
var _class = class {
  ...
  useCase;
  constructor(useCase = getInstanceByToken(FindAllModulesUseCase)) {
...
_class = _ts_decorate([
  ...
  _ts_metadata("design:type", Function),
  _ts_metadata("design:paramtypes", [
    typeof FindAllModulesUseCase === "undefined" ? Object : FindAllModulesUseCase
  ])
], _class);
export {
  _class as default
