...
// application/resources/modules/find-one/find-one.controller.ts
...
var _class = class {
  ...
  useCase;
  constructor(useCase = getInstanceByToken(FindOneModuleUseCase)) {
...
_class = _ts_decorate([
  ...
  _ts_metadata("design:type", Function),
  _ts_metadata("design:paramtypes", [
    typeof FindOneModuleUseCase === "undefined" ? Object : FindOneModuleUseCase
  ])
], _class);
export {
  _class as default
