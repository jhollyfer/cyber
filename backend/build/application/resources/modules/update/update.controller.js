import {
  UpdateModuleDocumentationSchema
} from "../../../../chunk-TNCUOHK5.js";
import {
  UpdateModuleBodySchema,
  UpdateModuleParamsSchema
} from "../../../../chunk-3DD2UUTL.js";
import {
  UpdateModuleUseCase
} from "../../../../chunk-47A6KXFH.js";
import {
...
// application/resources/modules/update/update.controller.ts
...
var _class = class {
  ...
  useCase;
  constructor(useCase = getInstanceByToken(UpdateModuleUseCase)) {
...
_class = _ts_decorate([
  ...
  _ts_metadata("design:type", Function),
  _ts_metadata("design:paramtypes", [
    typeof UpdateModuleUseCase === "undefined" ? Object : UpdateModuleUseCase
  ])
], _class);
export {
  _class as default
