...
// application/resources/questions/find-by-module/find-by-module.controller.ts
...
var _class = class {
  ...
  useCase;
  constructor(useCase = getInstanceByToken(FindByModuleUseCase)) {
...
_class = _ts_decorate([
  ...
  _ts_metadata("design:type", Function),
  _ts_metadata("design:paramtypes", [
    typeof FindByModuleUseCase === "undefined" ? Object : FindByModuleUseCase
  ])
], _class);
export {
  _class as default
