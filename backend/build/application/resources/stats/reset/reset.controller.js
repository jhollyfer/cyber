...
// application/resources/stats/reset/reset.controller.ts
...
var _class = class {
  ...
  useCase;
  constructor(useCase = getInstanceByToken(ResetGameDataUseCase)) {
...
_class = _ts_decorate([
  ...
  _ts_metadata("design:type", Function),
  _ts_metadata("design:paramtypes", [
    typeof ResetGameDataUseCase === "undefined" ? Object : ResetGameDataUseCase
  ])
], _class);
export {
  _class as default
