// application/resources/modules/update/update.schema.ts
import z from "zod";
var UpdateModuleParamsSchema = z.object({
  id: z.string().uuid("Invalid module ID")
});
var UpdateModuleBodySchema = z.object({
  ...
  time_per_question: z.number().int().positive().optional(),
  gradient: z.string().trim().optional(),
  category_color: z.string().trim().optional()
});
